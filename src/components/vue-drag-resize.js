...
export default {
    ...
    created: function () {
        ...
        this.rotateStartPos = {mouseX: 0, mouseY: 0, x: 0, y: 0, w: 0, h: 0};
        this.limits = {
            minLeft: null,
            maxLeft: null,
            minRight: null,
    ...
    methods: {
        ...
        rotateDown: function (ev) {
            ...
            this.rotateStartPos.mouseX = typeof ev.pageX !== 'undefined' ? ev.pageX : ev.touches[0].pageX;
            this.rotateStartPos.mouseY = typeof ev.pageY !== 'undefined' ? ev.pageY : ev.touches[0].pageY;
            this.rotateStartPos.left = this.left;
